...
var WhyNavigoSectionFallback = function () {
    return (react_1["default"].createElement("div", { className: "min-h-screen bg-background py-20 flex items-center justify-center" },
        react_1["default"].createElement("div", { className: "text-center" },
            react_1["default"].createElement(SectionTitle_1["default"], { title: "Why Navigo?", subtitle: "Loading interactive experience..." }),
            react_1["default"].createElement("div", { className: "mt-8 flex justify-center" },
                react_1["default"].createElement("div", { className: "animate-pulse flex space-x-4" },
                    react_1["default"].createElement("div", { className: "rounded-full bg-primary/30 h-12 w-12" }),
                    react_1["default"].createElement("div", { className: "flex-1 space-y-4 py-1 max-w-md" },
                        react_1["default"].createElement("div", { className: "h-4 bg-primary/20 rounded w-3/4" }),
                        react_1["default"].createElement("div", { className: "space-y-2" },
                            react_1["default"].createElement("div", { className: "h-4 bg-primary/10 rounded" }),
                            react_1["default"].createElement("div", { className: "h-4 bg-primary/10 rounded w-5/6" }))))))));
};
// Main component that replaces the "How Navigo Works" section
function WhyNavigoIntegration() {
    var _this = this;
    var _a = react_1.useState(false), assetsLoaded = _a[0], setAssetsLoaded = _a[1];
    react_1.useEffect(function () {
        // Function to preload SVG assets
        var preloadSvgs = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error('Error preloading SVGs:', error_1);
        ...
        var createPriyaPlaceholder = function () {

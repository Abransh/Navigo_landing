...
export const metadata: Metadata = {
  ...
  keywords: "India travel blog, local travel tips India, authentic India experiences, travel with locals India, India cultural insights, safety tips India travel, solo female travel India",
  openGraph: {
    title: "Navigo Blog | Travel Tips & Cultural Insights for Exploring India",
...
export default function BlogPage() {
  ...
  // Group posts by category (for potential filtering)
    ...
    <main className="min-h-screen bg-sand">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-12">
          ...
          <button className="bg-primary text-white px-4 py-1.5 rounded-full text-sm font-medium">
            All Posts
          </button>
          {categories.map((category) => (
            <button
              key={category}
              className="bg-white hover:bg-secondary/10 border border-border px-4 py-1.5 rounded-full text-sm font-medium text-navy transition-colors"
            >
              {category}
            </button>
          ))}
